  ...
  module Info
    class << self
      ...
      def impressum
        ...
        val << "<br/><hr/><small>Constituent records for this demo though realistic are entirely<br/>fictitious and <a target=\"_blank\" href=\"#{RUBYCAMPUS_ORG_BASE_URL}repositories/entry/#{RUBYCAMPUS}/lib/tasks/populate.rake\">randomly generated</a> every few hours.</small>" if RubyCampus.demo
        val
      end
