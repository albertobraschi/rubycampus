...
module MessageTemplateSpecHelper
  def valid_message_template_attributes
    {
      :name => "Inquiry Thank You",
      :subject => "Institute for RubyCampus Studies",
      :text => "Message TEXT",
      :html => "Message HTML"
    }
  end
...
describe MessageTemplate do
  ...
  include MessageTemplateSpecHelper
