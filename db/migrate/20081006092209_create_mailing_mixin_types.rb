...
class CreateMailingMixinTypes < ActiveRecord::Migration
  def self.up
    ...
    Fixtures.create_fixtures(RUBYCAMPUS_PATH_TO_DEFAULTS, File.basename("mailing_mixin_types.yml", '.*'))
  end

  def self.down
    drop_table :mailing_mixin_types
  end
end
