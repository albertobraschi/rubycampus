...
class CreatePreferredCommunicationMethods < ActiveRecord::Migration
  def self.up
    ...
    Fixtures.create_fixtures(RUBYCAMPUS_PATH_TO_DEFAULTS, File.basename("preferred_communication_methods.yml", '.*'))
  end

  def self.down
    drop_table :preferred_communication_methods
  end
end